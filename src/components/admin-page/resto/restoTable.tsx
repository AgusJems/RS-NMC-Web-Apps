...
export default function RestoTable() {
  const [data, setData] = useState<RestoItem[]>([]);
  ...
  const paginatedData = data.slice(
    ...
    const formatFullDate = (dateString:string) => {
        ...
        return `${D}, ${date.getDate()} ${F} ${Y} ${H}:${i}:${s}`;
    };
          ...
          <Table>
            <TableHeader className="border-b border-gray-100 dark:border-white/[0.08]">
              <TableRow>
                ...
                <TableCell
                  isHeader
                  className="px-6 py-4 text-center text-gray-700 dark:text-gray-300 min-w-[200px]"
                >
                  Date
                </TableCell>
            ...
            <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
              {paginatedData.map((item,index) => (
                <TableRow key={item.id}>
                  {/* No */}
                  <TableCell className="px-6 py-4 text-gray-600 dark:text-gray-300 font-normal text-center">
                    {index+1}.
                  </TableCell>
      ...
      >
        <div className="p-6 bg-white dark:bg-gray-900 rounded-3xl">
          <h4 className="text-2xl font-semibold mb-4 text-gray-500 dark:text-gray-400">
            {editingId ? "Edit Resto" : "Add Resto"}
          </h4>
