...
export default function IndicatorTable() {
  ...
  const addData = async () => {
    try {
      showLoading("Menyimpan indicator...");
      const res = await fetch(`${appSetting.apiUrl}/api/indicator`, {
        method: "POST",
  ...
  const updateData = async () => {
    try {
      showLoading("Memperbarui indicator...");
      const res = await fetch(
        `${appSetting.apiUrl}/api/indicator/${editingId}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(formData),
  ...
  const deleteData = async (id: number) => {
    ...
    try {
      ...
      const res = await fetch(`${appSetting.apiUrl}/api/indicator/${id}`, {
        method: "DELETE",
      });
      closeSwal();
  ...
  const editData = (item: IndicatorItem) => {
